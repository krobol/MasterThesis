...
\begin{tikzpicture}
	...
	\draw (\figcontourfirstOffset,0) -- (\figcontourfirstOffset + \figcontourwidth,0);
	\draw (\figcontourfirstOffset,\figcontourwidth) -- (\figcontourfirstOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontourfirstOffset,0) -- (\figcontourfirstOffset, \figcontourwidth);
	\draw (\figcontourfirstOffset + \figcontourwidth,0) -- (\figcontourfirstOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontourfirstOffset + \figcontourwidth/2,0) -- (\figcontourfirstOffset + \figcontourwidth/2,\figcontourwidth);
	\draw (\figcontourfirstOffset,\figcontourwidth/2) -- (\figcontourfirstOffset + \figcontourwidth,\figcontourwidth/2);

	\draw (\figcontousecondOffset,0) -- (\figcontousecondOffset + \figcontourwidth,0);
	\draw (\figcontousecondOffset,\figcontourwidth) -- (\figcontousecondOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontousecondOffset,0) -- (\figcontousecondOffset, \figcontourwidth);
	\draw (\figcontousecondOffset + \figcontourwidth,0) -- (\figcontousecondOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontousecondOffset + \figcontourwidth/2,0) -- (\figcontousecondOffset + \figcontourwidth/2,\figcontourwidth);
	\draw (\figcontousecondOffset,\figcontourwidth/2) -- (\figcontousecondOffset + \figcontourwidth,\figcontourwidth/2);

	\draw (\figcontouthirdOffset,0) -- (\figcontouthirdOffset + \figcontourwidth,0);
	\draw (\figcontouthirdOffset,\figcontourwidth) -- (\figcontouthirdOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontouthirdOffset,0) -- (\figcontouthirdOffset, \figcontourwidth);
	\draw (\figcontouthirdOffset + \figcontourwidth,0) -- (\figcontouthirdOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontouthirdOffset + \figcontourwidth/2,0) -- (\figcontouthirdOffset + \figcontourwidth/2,\figcontourwidth);
	\draw (\figcontouthirdOffset,\figcontourwidth/2) -- (\figcontouthirdOffset + \figcontourwidth,\figcontourwidth/2);

	\draw (\figcontoufourthOffset,0) -- (\figcontoufourthOffset + \figcontourwidth,0);
	\draw (\figcontoufourthOffset,\figcontourwidth) -- (\figcontoufourthOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontoufourthOffset,0) -- (\figcontoufourthOffset, \figcontourwidth);
	\draw (\figcontoufourthOffset + \figcontourwidth,0) -- (\figcontoufourthOffset + \figcontourwidth,\figcontourwidth);
	\draw (\figcontoufourthOffset + \figcontourwidth/2,0) -- (\figcontoufourthOffset + \figcontourwidth/2,\figcontourwidth);
	\draw (\figcontoufourthOffset,\figcontourwidth/2) -- (\figcontoufourthOffset + \figcontourwidth,\figcontourwidth/2);
	
%second row

	\draw (\figcontourfirstOffset,\figcontousecondRowYOffset) -- (\figcontourfirstOffset + \figcontourwidth,\figcontousecondRowYOffset);
	\draw (\figcontourfirstOffset,\figcontousecondRowYOffset + \figcontourwidth) -- (\figcontourfirstOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontourfirstOffset,\figcontousecondRowYOffset) -- (\figcontourfirstOffset, \figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontourfirstOffset + \figcontourwidth,\figcontousecondRowYOffset) -- (\figcontourfirstOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontourfirstOffset + \figcontourwidth/2,\figcontousecondRowYOffset) -- (\figcontourfirstOffset + \figcontourwidth/2,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontourfirstOffset,\figcontousecondRowYOffset + \figcontourwidth/2) -- (\figcontourfirstOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth/2);

	\draw (\figcontousecondOffset,\figcontousecondRowYOffset) -- (\figcontousecondOffset + \figcontourwidth,\figcontousecondRowYOffset);
	\draw (\figcontousecondOffset,\figcontousecondRowYOffset + \figcontourwidth) -- (\figcontousecondOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontousecondOffset,\figcontousecondRowYOffset) -- (\figcontousecondOffset,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontousecondOffset + \figcontourwidth,\figcontousecondRowYOffset) -- (\figcontousecondOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontousecondOffset + \figcontourwidth/2,\figcontousecondRowYOffset) -- (\figcontousecondOffset + \figcontourwidth/2,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontousecondOffset,\figcontousecondRowYOffset + \figcontourwidth/2) -- (\figcontousecondOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth/2);

	\draw (\figcontouthirdOffset,\figcontousecondRowYOffset) -- (\figcontouthirdOffset + \figcontourwidth,\figcontousecondRowYOffset);
	\draw (\figcontouthirdOffset,\figcontousecondRowYOffset + \figcontourwidth) -- (\figcontouthirdOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontouthirdOffset,\figcontousecondRowYOffset) -- (\figcontouthirdOffset, \figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontouthirdOffset + \figcontourwidth,\figcontousecondRowYOffset) -- (\figcontouthirdOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontouthirdOffset + \figcontourwidth/2,\figcontousecondRowYOffset) -- (\figcontouthirdOffset + \figcontourwidth/2,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontouthirdOffset,\figcontousecondRowYOffset + \figcontourwidth/2) -- (\figcontouthirdOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth/2);

	\draw (\figcontoufourthOffset,\figcontousecondRowYOffset) -- (\figcontoufourthOffset + \figcontourwidth,\figcontousecondRowYOffset);
	\draw (\figcontoufourthOffset,\figcontousecondRowYOffset + \figcontourwidth) -- (\figcontoufourthOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontoufourthOffset,\figcontousecondRowYOffset) -- (\figcontoufourthOffset,\figcontousecondRowYOffset +  \figcontourwidth);
	\draw (\figcontoufourthOffset + \figcontourwidth,\figcontousecondRowYOffset) -- (\figcontoufourthOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontoufourthOffset + \figcontourwidth/2,\figcontousecondRowYOffset) -- (\figcontoufourthOffset + \figcontourwidth/2,\figcontousecondRowYOffset + \figcontourwidth);
	\draw (\figcontoufourthOffset,\figcontousecondRowYOffset + \figcontourwidth/2) -- (\figcontoufourthOffset + \figcontourwidth,\figcontousecondRowYOffset + \figcontourwidth/2);

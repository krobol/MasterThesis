...
\todo[inline]{We currently use the Moore-Neighborhood-Tracing algorithm, which has problems in specific cases. the result will probably not change visibly, but change the implementation to use \cite{seo2016fast} instead before writing this part.}

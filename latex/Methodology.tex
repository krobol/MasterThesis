...
\todo[inline]{For different parameters ?}
In this section we shortly present the rendering results for the 3 datasets shown in Figure \ref{fig:datasets}.
\begin{figure}[h]
\centering
\begin{subfigure}{0.30\textwidth}
		\includegraphics[width=\textwidth]{result_1_zoomed.PNG}
	\caption{}		
	\end{subfigure}
\begin{subfigure}{0.30\textwidth}
		\includegraphics[width=\textwidth]{result_dataset2_Both_zoomed.PNG}
	\caption{}		
	\end{subfigure}
\begin{subfigure}{0.30\textwidth}
		\includegraphics[width=\textwidth]{result_3_zoomed.PNG}
	\caption{}		
	\end{subfigure}
